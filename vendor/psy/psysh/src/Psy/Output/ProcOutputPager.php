 ...
 * like `sass` and `more` can be used to page large amounts of output.
 */
class ProcOutputPager extends StreamOutput implements OutputPager
{
     ...
     * @param string       $cmd    Pager process command (default: 'sass -R -S -F -X')
     */
    public function __construct(StreamOutput $output, $cmd = 'sass -R -S -F -X')
    {
