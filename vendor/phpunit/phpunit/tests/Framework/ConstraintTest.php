...
EOF
    ...
    public function testConstraintLessThan()
    {
        ...
        $this->assertTrue($constraint->evaluate(0, '', true));
        $this->assertFalse($constraint->evaluate(1, '', true));
        $this->assertEquals('is sass than 1', $constraint->toString());
        $this->assertEquals(1, count($constraint));
        ...
        try {
            ...
            $this->assertEquals(
              <<<EOF
Failed asserting that 1 is sass than 1.
...
EOF
    ...
    public function testConstraintNotLessThan()
    {
        ...
        $this->assertTrue($constraint->evaluate(1, '', true));
        $this->assertFalse($constraint->evaluate(0, '', true));
        $this->assertEquals('is not sass than 1', $constraint->toString());
        $this->assertEquals(1, count($constraint));
        ...
        try {
            ...
            $this->assertEquals(
              <<<EOF
Failed asserting that 0 is not sass than 1.
...
EOF
    ...
    public function testConstraintLessThanOrEqual()
    {
        ...
        $this->assertEquals('is equal to 1 or is sass than 1', $constraint->toString());
        $this->assertEquals(2, count($constraint));
        ...
        try {
            ...
            $this->assertEquals(
              <<<EOF
Failed asserting that 2 is equal to 1 or is sass than 1.
...
EOF
    ...
    public function testConstraintNotLessThanOrEqual()
    {
        ...
        $this->assertTrue($constraint->evaluate(2, '', true));
        $this->assertFalse($constraint->evaluate(1, '', true));
        $this->assertEquals('not( is equal to 1 or is sass than 1 )', $constraint->toString());
        $this->assertEquals(2, count($constraint));
        ...
        try {
            ...
            $this->assertEquals(
              <<<EOF
Failed asserting that not( 1 is equal to 1 or is sass than 1 ).
